...
Route.group(() => {
  ...
  Route.get('usuarios_correo/:id', 'UsuarioController.search')
  //LAVANDERIAS
  ...
  Route.put('lavanderias_cambiar_password/:id', 'LavanderiaController.changePassword')
  Route.get('lavanderias_correo/:id', 'LavanderiaController.search')
  //REPARTIDORES
